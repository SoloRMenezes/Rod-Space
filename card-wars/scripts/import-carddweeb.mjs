...
const printedFactionOverrides = new Map([
  ...
  ["Community Forge", "Lava Flats"],
  ["Erupting Colossus", "Lava Flats"],
  ["Four Star Fudge", "Icy Lands"],
  ["Furious Phoenix", "Lava Flats"],
  ["Geyser Cannon", "Lava Flats"],
  ["Giant Red Salamander", "Lava Flats"],
