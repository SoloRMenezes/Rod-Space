...
console.log('PASS: 200 unique half-point cards, passing without reveal, discard, stealing, wins for 2/4/8 players, deck exhaustion, Orbit single RAF over 7200 frames, bounded bullets, shield loss and replay.');
